...
function validateIfExistsNewTask(){
    let values     = JSON.parse(localStorage.getItem(localStorageKey) || "[]") // Pegar os valores no localStorage
    let inputValue = document.getElementById('input-new-task').value // Pegar o valor digitado
